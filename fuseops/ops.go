...
type ReadFileOp struct {
	...
	// The readahead size if this is a read ahead, zero otherwise. The readhead size
	// may be larger than Size if limited by MaxPages or the availability of large folios.
